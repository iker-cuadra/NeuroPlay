...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input:focus {
            background: #fff;
            border-color: #0071e3; /* Azul Apple para foco */
            box-shadow: 0 0 0 4px rgba(0,113,227,0.1);
        }
 
        /* --- BOTÓN CLARO Y VIBRANTE --- */
        button {
            width: 100%;
            padding: 16px 24px;
            border-radius: 20px;
            ...
            background: #ffffff;
            color: #1d1d1f; /* Texto casi negro para máxima legibilidad */
        ...
        button:hover {
            background: #f5f5f7; /* Gris muy claro Apple */
            border-color: #86868b;
